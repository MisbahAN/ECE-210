...
#set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { EMV }]; #IO_L24P_T3_34 Sch=sw[1]
...
##LEDs
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { led[2] }]; #IO_L23P_T3_35 Sch=led[0]
